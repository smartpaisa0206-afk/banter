...
const faqs = [
  ...
  { q: 'How do I get the Android keyboard?', a: 'The native Android keyboard is a Phase 2 feature currently in private beta. Join the waitlist on the Keyboard page to be notified when it launches.' },
