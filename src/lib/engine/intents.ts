...
export const RELATIONSHIP_INTENTS: IntentConfig[] = [
  ...
  },
  {
    ...
    category: 'relationship',
    tier: 'all',
    tip: 'Keep it short, natural, meme-aware, and not try-hard.',
    examples: ['Reply to a dry text', 'Make a chat sound less boring'],
  },
  {
    id: 'roast_comeback',
    label: 'Roast / comeback',
    category: 'relationship',
    tier: 'all',
    sensitive: true,
    coach:
      'Roasts should be playful, not cruel. Keep it witty and safe — no slurs, hate, threats, bullying, or attacking protected traits. Aim for banter, not damage.',
    tip: 'Make it clever and light. Punch at the situation, not the person’s identity.',
    examples: ['Funny comeback to a friend', 'Playful roast in a group chat'],
  },
  {
    id: 'dm_reply',
    label: 'DM reply',
    category: 'relationship',
    tier: 'all',
    tip: 'Match their energy, answer clearly, and keep the conversation moving.',
    examples: ['Reply to an influencer', 'Respond to a new DM'],
  },
  {
    id: 'collab_reply',
    label: 'Collab reply',
    category: 'relationship',
    tier: 'all',
    tip: 'Be honest about budget, testing stage, and the next step.',
    examples: ['No paid budget yet', 'Ask creator to test the app'],
  },
  {
    id: 'apologize',
    label: 'Apologize',
